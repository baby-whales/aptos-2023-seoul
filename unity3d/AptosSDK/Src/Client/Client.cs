...
namespace Mirage.Aptos.SDK
{
	...
	public class Client
	{
		...
		protected readonly ClientServices _services;
		...
		public Task<MoveResource[]> GetAccountResources(string account)
		{
			return _services.AccountsService.GetAccountResources(account);
		}
        ...
        public Task<TokenEvent[]> GetTokenEventsByEventHandle(
			string address,
			string eventHandle,
			string fieldName,
			ulong? start = null,
        ...
        {
            return _services.EventsService.GetTokenEventsByEventHandle(
                address,
                eventHandle,
                fieldName,
                start,
