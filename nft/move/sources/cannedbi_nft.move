module cannedbi_nft::char_nft {
  ...
  fun init_module(resource_account: &signer) {
    // the collection name
    let collection_name = string::utf8(b"cannedbi NFT Collection");
    // the collection description
    let description = string::utf8(b"NFT issued by cannedbi.online");
    // the collection properity uri
    let collection_uri = string::utf8(b"https://cannedbi.online/properity/collection.svg");
  ...
  public entry fun mint_nft(receiver: &signer) acquires NFTMinter {
    let nft_minter = borrow_global_mut<NFTMinter>(@cannedbi_nft);
    ...
    let token_name = string::utf8(b"cannedbi NFT");
    let token_description = string::utf8(b"");
    let token_uri = string::utf8(b"https://cannedbi.online/properity/nft.svg");
