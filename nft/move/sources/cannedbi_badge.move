// objective : create a Badge NFT collection and claim Badges after gameplay
module cannedbi_nft::badge {
    use std::bcs;
    ...
    public entry fun init_collection(
        ...
        let token_mutate_setting = vector<bool>[false,true,true,true,true];//1,uri,royalty,description, properies
        ...
        ) acquires ResourceInfo,TokenMachine
    {
        ...
        mint_genesis_script_v1(
            minter,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #1"),//token_name : string::String,
            string::utf8(b"Awesome Badge NFT #1"),//description : string::String,
        ...
        ) acquires ResourceInfo,TokenMachine
    {
        ...
        mint_genesis_script_v1(
            minter,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #3"),//token_name : string::String,
            string::utf8(b"Awesome Badge NFT #3"),//description : string::String,
            uri,//token_uri : string::String,
            1000,
            stat1,stat2,stat3,stat4
        );
        ...
        ) acquires ResourceInfo,TokenMachine
    {
        ...
        mint_genesis_script_v1(
            minter,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #4"),//token_name : string::String,
            string::utf8(b"Awesome Badge NFT #4"),//description : string::String,
            uri,//token_uri : string::String,
            1000,
            stat1,stat2,stat3,stat4
        );
        ...
        mutate_tokendata_property(creator,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #4"),
            vector::empty(),
            vector::empty(),
            vector::empty()
        );
        ...
        ) acquires ResourceInfo,TokenMachine
    {
        ...
        mint_genesis_script_v1(
            minter,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #5"),//token_name : string::String,
            string::utf8(b"Awesome Badge NFT #5"),//description : string::String,
            uri,//token_uri : string::String,
            1000,
            stat1,stat2,stat3,stat4
        );
        ...
        mutate_tokendata_uri(creator,
            token_machine_addr,
            string::utf8(b"Cannedbi Badge #5"),
